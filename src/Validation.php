...
class Validation {
     ...
     * @return float
     */
    public function cal_distance(float $lat1 = 0, float $lon1 = 0, float $lat2 = 0, float $lon2 = 0): float {
        $the = $lon1 - $lon2;
     ...
     * @return bool
     */
    public function validateOn(string $value = ""): bool {
        if (empty($value) === true) {
            return false;
        }
        $length = strlen($value);
     ...
     * @return bool
     */
    public function validateBsn(string $value = ""): bool {
        if (empty($value) === true) {
            return false;
        }
     ...
     * @return bool
     */
    public function validateBtw(string $value = ""): bool {
        if (empty($value) === true) {
            return false;
        }
     ...
     * @return bool
     */
    public function validateIban(string $value = ""): bool {
        if (empty($value) === true) {
            return false;
        }
